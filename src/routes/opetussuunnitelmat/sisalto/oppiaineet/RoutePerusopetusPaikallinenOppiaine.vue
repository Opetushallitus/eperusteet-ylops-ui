        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <ep-form-content name="vuosiluokat-joilla-esintyy">
              ...
              >
                <b-form-checkbox
                  v-for="(vuosiluokka, index) in data.perusteVuosiluokat"
                  :key="'vl' + index"
                  :value="vuosiluokka"
                >
          ...
          <div class="col-md-12">
            <vuosiluokka-sisalto-teksti
              ...
              :vlk-object="data.vuosiluokkakokonaisuus.tehtava"
              :is-editing="isEditing"
            >
              <template #header>
          ...
          <div class="col-md-12">
            <vuosiluokka-sisalto-teksti
              ...
              :vlk-object="data.vuosiluokkakokonaisuus.tyotavat"
              :is-editing="isEditing"
            >
              <template #header>
          ...
          <div class="col-md-12">
            <vuosiluokka-sisalto-teksti
              ...
              :vlk-object="data.vuosiluokkakokonaisuus.ohjaus"
              :is-editing="isEditing"
            >
              <template #header>
          ...
          <div class="col-md-12">
            <vuosiluokka-sisalto-teksti
              ...
              :vlk-object="data.vuosiluokkakokonaisuus.arviointi"
              :is-editing="isEditing"
            >
              <template #header>
          ...
          <div class="col-md-12">
            <vuosiluokka-sisalto-teksti
              ...
              :vlk-object="data.vuosiluokkakokonaisuus.tavoitteistaJohdetutOppimisenTavoitteet"
              :is-editing="isEditing"
            >
              <template #header>
