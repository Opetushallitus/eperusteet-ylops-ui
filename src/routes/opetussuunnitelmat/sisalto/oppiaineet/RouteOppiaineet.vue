...
<div class="content">
  ...
  <div class="row">
    ...
    <div class="col-md-3">
      <div>
        <ep-button v-oikeustarkastelu="'muokkaus'" variant="outline-primary" icon="plussa" @click="uusiOppiaine()">{{ $t('paikallinen-oppiaine') }}</ep-button>
        <ep-button v-oikeustarkastelu="'muokkaus'" variant="outline-primary" icon="plussa" @click="uusiOpintojakso()">{{ $t('opintojakso') }}</ep-button>
      </div>
    </div>
  </div>
