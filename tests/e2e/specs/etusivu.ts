...
describe('Etusivu', () => {
  ...
  function createServer() {
    ...
    cy.route({
      ...
      response: [
        { id : 1, julkaisukielet : [ "fi" ], nimi: { fi: "Testipohja (id: 1, fi)" }, tila: 'luonnos', luotu: 1547644623926, },
        { id : 2, julkaisukielet : [ "fi","sv" ], nimi: { sv: "Testipohja (id: 2, sv)" }, tila: 'luonnos', luotu: 1548336267382, },
        { id : 3, julkaisukielet : [ "sv" ], nimi: { fi: "Testipohja (id: 3, fi)" }, tila: 'luonnos', luotu: 1550336267382, },
      ]
    });
    cy.route({
      method: 'GET',
